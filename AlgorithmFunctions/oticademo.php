    ...
    <body>
        ...
        <div class="modal fade" id="degrau" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe width="100%" height="100%" scrolling="no" src="https://react-facedetect.herokuapp.com/?k=1010" allow="camera *;microphone *">
                </iframe>
                </div>
            </div>
            </div>
        ...
        <div class="modal fade" id="desol" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe width="100%" height="100%" scrolling="no" src="https://react-facedetect.herokuapp.com/?k=1012" allow="camera *;microphone *">
                </iframe>
                </div>
            </div>
            </div>
